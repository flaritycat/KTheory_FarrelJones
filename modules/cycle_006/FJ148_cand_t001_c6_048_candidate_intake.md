# Module FJ148. CAND-T001-C6-048 Candidate Intake
...
The callback queue row `PAY-T001-CAND-C6-048-2026-001` is the first row in
`ledgers/payload_execution_queue.md` marked `Ready for intake` after `FJ147`.
...
| Field | Entry |
| --- | --- |
| Payload ID | `PAY-T001-CAND-C6-048-2026-001` |
...
| Candidate, source, bridge, computation, or blocker | Candidate `CAND-T001-C6-048`, \(G_{C6,048}=\langle a,b\mid a b^{50} a^{-1} b^{-99} a b^{100} a^{-1} b^{-50}\rangle\), with \(\chi(a)=1,\chi(b)=0\). |
...
| Source-status label | Internal candidate-generation payload. Torsion-free status uses only the existing repository row: Putman's notes are an active reference for `FJ91` and `FJ101`--`FJ148`; first-pass theorem text checked for the non-proper-power torsion-free corollary. No browsing and no new source check. |
...
| Accepted? | Yes, for `FJ148` candidate-intake audit only. |
| Follow-up module if accepted | `modules/cycle_006/FJ148_cand_t001_c6_048_candidate_intake.md` |
...
\qquad
r=a b^{50} a^{-1} b^{-99} a b^{100} a^{-1} b^{-50}.
\]
...
\[
\bar\chi\colon G_{C6,048}\to\mathbb Z.
\]
...
`CAND-T001-C6-048` is torsion-free at first-pass candidate-ledger level.
...
`CAND-T001-C6-048` is candidate-admissible at first-pass intake level and
route-unresolved.

The row has:

- a concrete two-generator one-relator presentation;
- a first-pass non-proper-power check;
- first-pass torsion-free candidate status using the existing repository
  source-status row;
- the epimorphism \(\bar\chi\colon G_{C6,048}\to\mathbb Z\) is recorded;
- no known route or prior-art blocker recorded.

## Proof obligation created

`OBL-C6-051`: do not promote, route, or treat as residual-subtractive
`CAND-T001-C6-048` unless a new accepted payload supplies one of:
...
Brown/BNS data in `FJ148`. Do not execute queue row `049` in this run.
...
- `modules/cycle_006/FJ119_cand_t001_c6_019_candidate_intake.md`;
- `modules/cycle_006/FJ120_cand_t001_c6_020_candidate_intake.md`;
- `modules/cycle_006/FJ121_cand_t001_c6_021_candidate_intake.md`;
- `modules/cycle_006/FJ122_cand_t001_c6_022_candidate_intake.md`;
- `modules/cycle_006/FJ123_cand_t001_c6_023_candidate_intake.md`;
- `modules/cycle_006/FJ124_cand_t001_c6_024_candidate_intake.md`;
- `modules/cycle_006/FJ125_cand_t001_c6_025_candidate_intake.md`;
- `modules/cycle_006/FJ126_cand_t001_c6_026_candidate_intake.md`;
- `modules/cycle_006/FJ127_cand_t001_c6_027_candidate_intake.md`;
- `modules/cycle_006/FJ128_cand_t001_c6_028_candidate_intake.md`;
- `modules/cycle_006/FJ129_cand_t001_c6_029_candidate_intake.md`;
- `modules/cycle_006/FJ130_cand_t001_c6_030_candidate_intake.md`;
- `modules/cycle_006/FJ131_cand_t001_c6_031_candidate_intake.md`;
- `modules/cycle_006/FJ132_cand_t001_c6_032_candidate_intake.md`;
- `modules/cycle_006/FJ133_cand_t001_c6_033_candidate_intake.md`;
- `modules/cycle_006/FJ134_cand_t001_c6_034_candidate_intake.md`;
- `modules/cycle_006/FJ135_cand_t001_c6_035_candidate_intake.md`;
- `modules/cycle_006/FJ136_cand_t001_c6_036_candidate_intake.md`;
- `modules/cycle_006/FJ137_cand_t001_c6_037_candidate_intake.md`;
- `modules/cycle_006/FJ138_cand_t001_c6_038_candidate_intake.md`;
- `modules/cycle_006/FJ139_cand_t001_c6_039_candidate_intake.md`;
- `modules/cycle_006/FJ140_cand_t001_c6_040_candidate_intake.md`;
- `modules/cycle_006/FJ141_cand_t001_c6_041_candidate_intake.md`;
- `modules/cycle_006/FJ142_cand_t001_c6_042_candidate_intake.md`;
- `modules/cycle_006/FJ143_cand_t001_c6_043_candidate_intake.md`;
- `modules/cycle_006/FJ144_cand_t001_c6_044_candidate_intake.md`;
- `modules/cycle_006/FJ145_cand_t001_c6_045_candidate_intake.md`;
- `modules/cycle_006/FJ146_cand_t001_c6_046_candidate_intake.md`;
- `modules/cycle_006/FJ147_cand_t001_c6_047_candidate_intake.md`;
...
- accepted intake of `PAY-T001-CAND-C6-048-2026-001` for `FJ148` only;
- candidate row `CAND-T001-C6-048`;
...
- first-pass torsion-free candidate status using the existing `FJ91` and
  `FJ101`--`FJ148` source status for Putman;
- epimorphism \(\bar\chi\colon G_{C6,048}\to\mathbb Z\);
- proof obligation `OBL-C6-051`.

No established result number is produced.

## Open questions generated

- `OQ-174`: Which accepted payload, if any, should act on
  `CAND-T001-C6-048` after the `FJ148` candidate-intake audit?
