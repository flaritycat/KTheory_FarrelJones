...
- continue-payload queue and FJ101--FJ130 intake: `FJ101` consumes only row
  ...
  `FJ130` consumes only row `030` of
  ...
  `OBL-C6-032`, and `OQ-156` / `OBL-C6-033`, and making no
...
`ledgers/payload_execution_queue.md` rows `001`--`030` have been completed by
`FJ101`--`FJ130`; the next mathematical move requires either the exact
