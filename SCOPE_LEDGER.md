...
88. Can `FJ64` produce a candidate-admissible row from `DAP-T001-001`, or must it record a no-candidate note? Tracked as `OQ-086`; generated by `FJ63` and selected for `FJ64`.
