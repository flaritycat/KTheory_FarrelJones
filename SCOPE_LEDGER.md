...
66. Should `RB-004` continue through Bieri--Renz/BNS source verification, or pivot because the current source cluster has not produced a new concrete route? Tracked as `OQ-064`; selected for `FJ43`.
...
Begin `FJ43`, a route-delta checkpoint for the BNS/Bieri/Karrass--Solitar
source cluster.
