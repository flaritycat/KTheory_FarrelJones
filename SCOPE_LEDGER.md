...
- continue-payload queue and FJ101--FJ137 intake: `FJ101` consumes only row
  ...
  `FJ136` consumes only row `036`, and `FJ137` consumes only row `037` of
  ...
  `OBL-C6-038`, `OQ-162` / `OBL-C6-039`, and `OQ-163` / `OBL-C6-040`, and making no
...
`FJ101`--`FJ137`; the next mathematical move requires either the exact
