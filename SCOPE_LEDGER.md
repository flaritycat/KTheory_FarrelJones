...
- continue-payload queue and FJ101--FJ122 intake: `FJ101` consumes only row
  ...
  `FJ120` consumes only row `020`, `FJ121` consumes only row `021`, and
  `FJ122` consumes only row `022` of
  ...
  `OBL-C6-024`, and `OQ-148` / `OBL-C6-025`, and making no
...
`ledgers/payload_execution_queue.md` rows `001`--`022` have been completed by
`FJ101`--`FJ122`; the next mathematical move requires either the exact
