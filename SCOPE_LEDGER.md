...
65. What exact theorem in Bieri (1976) is needed for normal subgroups of cohomological-dimension-\(2\) groups, and what finiteness hypothesis does it require? Tracked as `OQ-063`; selected for `FJ42`.
