...
8. Which source should serve as the main reference for the modern statement of Farrell--Jones? Selected for the `FJ02` interruption by `FJ46`.
9. Which model of nonconnective algebraic \(K\)-theory should be used for the all-integers formulation? Selected for the `FJ02` interruption by `FJ46`.
...
24. Which source should reconcile `FJCw`, `FICwF`, and the project's simplified K-theory formulation? Selected for the `FJ02` interruption by `FJ46`.
...
Interrupt cycle 003 and begin `FJ02`, the additive-category/source-convention
formulation module needed before further proof-sensitive `RB-005` work.
