...
86. Which active blockers should `FJ62` preserve for `T-001` candidate intake, and which should be moved to deferred or historical status? Tracked as `OQ-084`; generated by `FJ61` and selected for `FJ62`.
