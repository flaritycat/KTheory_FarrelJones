...
- continue-payload queue and FJ101--FJ120 intake: `FJ101` consumes only row
  ...
  `FJ118` consumes only row `018`, `FJ119` consumes only row `019`, and
  `FJ120` consumes only row `020` of
  ...
  `OBL-C6-022`, and `OQ-146` / `OBL-C6-023`, and making no
...
`ledgers/payload_execution_queue.md` rows `001`--`020` have been completed by
`FJ101`--`FJ120`; the next mathematical move requires either the exact
