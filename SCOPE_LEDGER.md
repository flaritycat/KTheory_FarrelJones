...
- continue-payload queue and FJ101--FJ119 intake: `FJ101` consumes only row
  ...
  `FJ118` consumes only row `018`, and `FJ119` consumes only row `019` of
  ...
  `OBL-C6-022`, and making no Farrell--Jones theorem claim or residual
  subtraction;
...
`ledgers/payload_execution_queue.md` rows `001`--`019` have been completed by
`FJ101`--`FJ119`; the next mathematical move requires either the exact
