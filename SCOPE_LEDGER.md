...
74. Which one-relator cubulation, specialness, or CAT(0)-recognition source can make `RB-006` candidate-ready without duplicating the hyperbolic route? Tracked as `OQ-072`; generated by `FJ50` and selected for `FJ51`.
