...
70. Which source verifies a coefficient K-theory finite-index overgroup bridge under the `FJ02` convention? Tracked as `OQ-068`; generated by `FJ02` and selected for `FJ47`.
...
Begin `FJ47`, selecting or verifying a coefficient K-theory finite-index
overgroup bridge under the `FJ02` source convention.
