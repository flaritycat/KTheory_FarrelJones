...
- continue-payload queue and FJ101--FJ135 intake: `FJ101` consumes only row
  ...
  `FJ134` consumes only row `034`, and `FJ135` consumes only row `035` of
  ...
  `OBL-C6-036`, `OQ-160` / `OBL-C6-037`, and `OQ-161` /
  `OBL-C6-038`, and making no
...
`FJ101`--`FJ135`; the next mathematical move requires either the exact
