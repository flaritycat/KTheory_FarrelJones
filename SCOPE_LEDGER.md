...
- continue-payload queue and FJ101/FJ102/FJ103/FJ104/FJ105 intake: `FJ101`
  consumes only row `001`, `FJ102` consumes only row `002`, `FJ103` consumes
  only row `003`, `FJ104` consumes only row `004`, and `FJ105` consumes only
  row `005` of
  ...
  and `CAND-T001-C6-005` as candidate-admissible but route-unresolved rows,
  creating `OQ-127` / `OBL-C6-004`, `OQ-128` / `OBL-C6-005`, `OQ-129` /
  `OBL-C6-006`, `OQ-130` / `OBL-C6-007`, and `OQ-131` / `OBL-C6-008`, and
  making no Farrell--Jones theorem claim or residual subtraction;
...
`ledgers/payload_execution_queue.md` rows `001`--`005` have been completed by
`FJ101`--`FJ105`; the next mathematical move requires either the exact
