...
- continue-payload queue and FJ101--FJ138 intake: `FJ101` consumes only row
  ...
  `FJ136` consumes only row `036`, and `FJ137` consumes only row `037`, and `FJ138` consumes only row `038` of
  ...
  `OBL-C6-038`, `OQ-162` / `OBL-C6-039`, and `OQ-163` / `OBL-C6-040`, and `OQ-164` / `OBL-C6-041`, and making no
...
`ledgers/payload_execution_queue.md` rows `001`--`034` have been completed by
`FJ101`--`FJ138`; the next mathematical move requires either the exact
