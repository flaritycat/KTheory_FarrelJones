...
156. Which accepted payload, if any, should act on `CAND-T001-C6-026` after `FJ126`? Tracked as `OQ-152`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
157. Which accepted payload, if any, should act on `CAND-T001-C6-027` after `FJ127`? Tracked as `OQ-153`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
158. Which accepted payload, if any, should act on `CAND-T001-C6-028` after `FJ128`? Tracked as `OQ-154`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
159. Which accepted payload, if any, should act on `CAND-T001-C6-029` after `FJ129`? Tracked as `OQ-155`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
160. Which accepted payload, if any, should act on `CAND-T001-C6-030` after `FJ130`? Tracked as `OQ-156`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
161. Which accepted payload, if any, should act on `CAND-T001-C6-031` after `FJ131`? Tracked as `OQ-157`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
162. Which accepted payload, if any, should act on `CAND-T001-C6-032` after `FJ132`? Tracked as `OQ-158`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
163. Which accepted payload, if any, should act on `CAND-T001-C6-033` after `FJ133`? Tracked as `OQ-159`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
164. Which accepted payload, if any, should act on `CAND-T001-C6-034` after `FJ134`? Tracked as `OQ-160`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
165. Which accepted payload, if any, should act on `CAND-T001-C6-035` after `FJ135`? Tracked as `OQ-161`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
166. Which accepted payload, if any, should act on `CAND-T001-C6-036` after `FJ136`? Tracked as `OQ-162`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
167. Which accepted payload, if any, should act on `CAND-T001-C6-037` after `FJ137`? Tracked as `OQ-163`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
168. Which accepted payload, if any, should act on `CAND-T001-C6-038` after `FJ138`? Tracked as `OQ-164`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.

169. Which accepted payload, if any, should act on `CAND-T001-C6-039` after `FJ139`? Tracked as `OQ-165`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.

170. Which accepted payload, if any, should act on `CAND-T001-C6-040` after `FJ140`? Tracked as `OQ-166`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
171. Which accepted payload, if any, should act on `CAND-T001-C6-041` after `FJ141`? Tracked as `OQ-167`; open and blocked until a kernel-control, route/prior-art, formulation, route-bridge, or branch payload is accepted.
...
- continue-payload queue and FJ101--FJ146 intake: `FJ101` consumes only row
  ...
  `FJ124` consumes only row `024`, `FJ125` consumes only row `025`,
  `FJ126` consumes only row `026`, `FJ127` consumes only row `027`,
  `FJ128` consumes only row `028`, `FJ129` consumes only row `029`, and
  ...
  `FJ136` consumes only row `036`, `FJ137` consumes only row `037`, `FJ138` consumes only row `038`, `FJ139` consumes only row `039`, `FJ140` consumes only row `040`, `FJ141` consumes only row `041`, `FJ142` consumes only row `042`, `FJ143` consumes only row `043`, `FJ144` consumes only row `044`, `FJ145` consumes only row `045`, and `FJ146` consumes only row `046` of
  ...
  `OBL-C6-028`, and `OQ-152` / `OBL-C6-029`, and `OQ-153` /
  `OBL-C6-030`, and `OQ-154` / `OBL-C6-031`, and `OQ-155` /
  ...
  `OBL-C6-038`, `OQ-162` / `OBL-C6-039`, and `OQ-163` / `OBL-C6-040`, `OQ-164` / `OBL-C6-041`, `OQ-165` / `OBL-C6-042`, `OQ-166` / `OBL-C6-043`, `OQ-167` / `OBL-C6-044`, `OQ-168` / `OBL-C6-045`, `OQ-169` / `OBL-C6-046`, `OQ-170` / `OBL-C6-047`, `OQ-171` / `OBL-C6-048`, and `OQ-172` / `OBL-C6-049`, and making no
...
`ledgers/payload_execution_queue.md` rows `001`--`046` have been completed by
`FJ101`--`FJ146`; the next mathematical move requires either the exact
