...
- continue-payload queue and FJ101--FJ126 intake: `FJ101` consumes only row
  ...
  `FJ124` consumes only row `024`, `FJ125` consumes only row `025`, and
  `FJ126` consumes only row `026` of
  ...
  `OBL-C6-028`, and `OQ-152` / `OBL-C6-029`, and making no
...
`ledgers/payload_execution_queue.md` rows `001`--`026` have been completed by
`FJ101`--`FJ126`; the next mathematical move requires either the exact
