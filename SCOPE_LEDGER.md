...
- continue-payload queue and FJ101--FJ136 intake: `FJ101` consumes only row
  ...
  `FJ136` consumes only row `036` of
  ...
  `OBL-C6-038`, and `OQ-162` / `OBL-C6-039`, and making no
...
`FJ101`--`FJ136`; the next mathematical move requires either the exact
