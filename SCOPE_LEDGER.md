...
- continue-payload queue and FJ101--FJ134 intake: `FJ101` consumes only row
  ...
  `FJ134` consumes only row `034` of
  ...
  `OBL-C6-036`, and `OQ-160` / `OBL-C6-037`, and making no
...
`FJ101`--`FJ134`; the next mathematical move requires either the exact
