...
69. Should `RB-005` next verify a coefficient K-theory finite-index overgroup theorem, or interrupt for `FJ02`/source-convention reconciliation? Tracked as `OQ-067`; generated by `FJ45` and selected for `FJ46`.
...
Begin `FJ46`, deciding whether `RB-005` should proceed by source-verifying a
