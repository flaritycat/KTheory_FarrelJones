...
79. Which repository-supported candidate rows can receive explicit kernel-control data for the `RB-003` + `RB-004`/`RB-008` hybrid packet? Tracked as `OQ-077`; generated by `FJ55` and selected for `FJ56`.
