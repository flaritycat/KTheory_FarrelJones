...
`FJ129`, accepted row-030 candidate intake in `FJ130`, and accepted row-031
candidate intake in `FJ131`.
...
- `FJ01`--`FJ131` are the completed numbered module archive, with `FJ53`
...
- `FJ131` later consumed `PAY-T001-CAND-C6-031-2026-001` from
  ...
  candidate-admissible but route-unresolved row;
- `OQ-126` is resolved only for rows 001--031, while `OQ-127` /
  ...
  `OBL-C6-034` govern follow-up work on `CAND-T001-C6-031`;
