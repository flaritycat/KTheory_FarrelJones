...
intake in `FJ107`, and accepted row-008 candidate intake in `FJ108`. The
...
- `FJ01`--`FJ108` are the completed numbered module archive, with `FJ53`
...
- `FJ108` later consumed `PAY-T001-CAND-C6-008-2026-001` from
  ...
  candidate-admissible but route-unresolved row;
- `OQ-126` is resolved only for rows 001--008, while `OQ-127` /
  ...
  `OBL-C6-011` govern follow-up work on `CAND-T001-C6-008`;
