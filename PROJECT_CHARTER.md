...
accepted row-022 candidate intake in `FJ122`.
...
- `FJ01`--`FJ122` are the completed numbered module archive, with `FJ53`
...
- `FJ122` later consumed `PAY-T001-CAND-C6-022-2026-001` from
  ...
  candidate-admissible but route-unresolved row;
- `OQ-126` is resolved only for rows 001--022, while `OQ-127` /
  ...
  `OBL-C6-025` govern follow-up work on `CAND-T001-C6-022`;
