...
candidate intake in `FJ134`, and accepted row-035 candidate intake in `FJ135`, and accepted row-036 candidate intake in `FJ136`.
...
- `FJ01`--`FJ136` are the completed numbered module archive, with `FJ53`
...
- `FJ136` later consumed `PAY-T001-CAND-C6-036-2026-001` from
  ...
  candidate-admissible but route-unresolved row;
- `OQ-126` is resolved only for rows 001--036, while `OQ-127` /
  ...
  `OQ-162` / `OBL-C6-039` govern follow-up work on `CAND-T001-C6-036`;
