...
- `FJ01`--`FJ123` are the completed numbered module archive, with `FJ53`
...
- `FJ123` later consumed `PAY-T001-CAND-C6-023-2026-001` from
  ...
  candidate-admissible but route-unresolved row;
- `OQ-126` is resolved only for rows 001--023, while `OQ-127` /
  ...
  `OBL-C6-026` govern follow-up work on `CAND-T001-C6-023`;
