...
and accepted row-013 candidate intake in `FJ113`.
...
- `FJ01`--`FJ113` are the completed numbered module archive, with `FJ53`
...
- `FJ113` later consumed `PAY-T001-CAND-C6-013-2026-001` from
  ...
  candidate-admissible but route-unresolved row;
- `OQ-126` is resolved only for rows 001--013, while `OQ-127` /
  ...
  `OBL-C6-016` govern follow-up work on `CAND-T001-C6-013`;
