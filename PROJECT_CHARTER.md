...
`FJ129`, and accepted row-030 candidate intake in `FJ130`.
...
- `FJ01`--`FJ130` are the completed numbered module archive, with `FJ53`
...
- `FJ130` later consumed `PAY-T001-CAND-C6-030-2026-001` from
  ...
  candidate-admissible but route-unresolved row;
- `OQ-126` is resolved only for rows 001--030, while `OQ-127` /
  ...
  `OBL-C6-033` govern follow-up work on `CAND-T001-C6-030`;
