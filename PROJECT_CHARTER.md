...
- `FJ01`--`FJ132` are the completed numbered module archive, with `FJ53`
...
- `FJ132` later consumed `PAY-T001-CAND-C6-032-2026-001` from
  ...
  candidate-admissible but route-unresolved row;
- `OQ-126` is resolved only for rows 001--032, while `OQ-127` /
  ...
  `OBL-C6-035` govern follow-up work on `CAND-T001-C6-032`;
