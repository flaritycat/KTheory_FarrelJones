...
candidate intake in `FJ134`, and accepted row-035 candidate intake in `FJ135`, and accepted row-036 candidate intake in `FJ136`, and accepted row-037 candidate intake in `FJ137`, and accepted row-038 candidate intake in `FJ138`, and accepted row-039 candidate intake in `FJ139`, and accepted row-040 candidate intake in `FJ140`, accepted row-041 candidate intake in `FJ141`, accepted row-042 candidate intake in `FJ142`, accepted row-043 candidate intake in `FJ143`, and accepted row-044 candidate intake in `FJ144`, and accepted row-045 candidate intake in `FJ145`, and accepted row-046 candidate intake in `FJ146`, and accepted row-047 candidate intake in `FJ147`, and accepted row-048 candidate intake in `FJ148`.
...
- `FJ01`--`FJ148` are the completed numbered module archive, with `FJ53`
...
- `FJ137` later consumed `PAY-T001-CAND-C6-037-2026-001` from
  ...
  candidate-admissible but route-unresolved row;
- `FJ138` later consumed `PAY-T001-CAND-C6-038-2026-001` from
  `ledgers/payload_execution_queue.md` and added `CAND-T001-C6-038` as a
  candidate-admissible but route-unresolved row;
- `FJ139` later consumed `PAY-T001-CAND-C6-039-2026-001` from
  `ledgers/payload_execution_queue.md` and added `CAND-T001-C6-039` as a
  candidate-admissible but route-unresolved row;
- `FJ140` later consumed `PAY-T001-CAND-C6-040-2026-001` from
  `ledgers/payload_execution_queue.md` and added `CAND-T001-C6-040` as a
  candidate-admissible but route-unresolved row;
- `OQ-126` is resolved only for rows 001--048, while `OQ-127` /
  ...
  `OQ-167` / `OBL-C6-044` govern follow-up work on `CAND-T001-C6-041`, and
  `OQ-168` / `OBL-C6-045` govern follow-up work on `CAND-T001-C6-042`, and
  `OQ-169` / `OBL-C6-046` govern follow-up work on `CAND-T001-C6-043`, and
  `OQ-170` / `OBL-C6-047` govern follow-up work on `CAND-T001-C6-044`, and `OQ-171` / `OBL-C6-048` govern follow-up work on `CAND-T001-C6-045`, and `OQ-172` / `OBL-C6-049` govern follow-up work on `CAND-T001-C6-046`, and `OQ-173` / `OBL-C6-050` govern follow-up work on `CAND-T001-C6-047`, and `OQ-174` / `OBL-C6-051` govern follow-up work on `CAND-T001-C6-048`;
