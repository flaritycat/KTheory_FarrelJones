...
accepted row-019 candidate intake in `FJ119`.
...
- `FJ01`--`FJ119` are the completed numbered module archive, with `FJ53`
...
- `FJ119` later consumed `PAY-T001-CAND-C6-019-2026-001` from
  ...
  candidate-admissible but route-unresolved row;
- `OQ-126` is resolved only for rows 001--019, while `OQ-127` /
  ...
  `OBL-C6-022` govern follow-up work on `CAND-T001-C6-019`;
