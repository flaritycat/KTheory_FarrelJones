...
intake in `FJ117`, and accepted row-018 candidate intake in `FJ118`.
...
- `FJ01`--`FJ118` are the completed numbered module archive, with `FJ53`
...
- `FJ118` later consumed `PAY-T001-CAND-C6-018-2026-001` from
  ...
  candidate-admissible but route-unresolved row;
- `OQ-126` is resolved only for rows 001--018, while `OQ-127` /
  ...
  `OBL-C6-021` govern follow-up work on `CAND-T001-C6-018`;
