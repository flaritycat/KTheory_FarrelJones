...
- Bartels, A., Lueck, W., & Reich, H. (2008). The K-theoretic Farrell-Jones conjecture for hyperbolic groups. *Inventiones Mathematicae, 172*(1), 29--70. https://doi.org/10.1007/s00222-007-0093-7. Status: `active reference for FJ11 and FJ13; partially read overall`. Notes: `FJ11` checked the main theorem for K-theoretic Farrell--Jones with coefficients for hyperbolic groups in all degrees; `FJ13` checked the introduction proof outline, Theorem "Axiomatic Formulation", and Section 2 hyperbolic verification. arXiv version: https://arxiv.org/abs/math/0701434.
...
- Wegner, C. (2012). The K-theoretic Farrell-Jones conjecture for CAT(0)-groups. *Proceedings of the American Mathematical Society, 140*(3), 779--793. https://doi.org/10.1090/S0002-9939-2011-11150-X. Status: `active reference for FJ11 and FJ14; partially read overall`. Notes: used in `FJ11` for full K-theoretic Farrell--Jones with coefficients for finite-dimensional CAT(0)-groups; `FJ14` checked the introduction, main theorem, strong-transfer-reducibility route, and CAT(0)-group verification theorem. arXiv version: https://arxiv.org/abs/1012.3349.
