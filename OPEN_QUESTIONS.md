...
`FJ51` selects Louder--Wilton for a bounded source-boundary check. Continue
with `OQ-073`/`FJ52`.
...
Resolved by `FJ51`. Continue with `OQ-073`/`FJ52`.

## OQ-073. Does Louder--Wilton give an RB-006 route delta?

### Status

Open inside project; generated by `FJ51` and selected for `FJ52`.
...
Louder--Wilton (2022), `ledgers/source_status.md`,
`ledgers/t001_residual.md`, and the stop condition from `FJ51`.
