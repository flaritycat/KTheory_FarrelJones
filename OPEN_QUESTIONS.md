...
Partially resolved by `FJ45` and sharpened by `FJ48`; still open for direct
...
their exact source lanes. Continue with `OQ-070`/`FJ49`, checking whether a
direct finite-dimensional CAT(0) finite-extension bridge can support the
virtual compact special cases.
...
application case. Continue with `OQ-070`/`FJ49`.
...
Resolved by `FJ48`. Continue with `OQ-070`/`FJ49`, checking the direct
finite-dimensional CAT(0) finite-extension bridge for virtual compact
special cases.
...
Open inside project; generated by `FJ48` and selected for `FJ49`.
...
`ledgers/t001_residual.md`, and a source checked in `FJ49` for finite
extensions of CAT(0)-groups.

### Next action

Begin `FJ49`, direct finite-dimensional CAT(0) finite-extension bridge
source check.
