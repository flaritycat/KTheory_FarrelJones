...
`PAY-T001-CAND-C6-008-2026-001` only; callback queue remains active for
later rows.
...
`FJ101`, `FJ102`, `FJ103`, `FJ104`, `FJ105`, `FJ106`, `FJ107`, and `FJ108` have instantiated the first eight
concrete callback-queue rows. Future numbered work still requires a concrete accepted payload. The
