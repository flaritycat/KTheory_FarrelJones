...
Open inside project; generated by `FJ70` and selected for `FJ71`.
...
The next module should make a branch decision for the active Artin lane. It
must not become a broad Artin source survey.
