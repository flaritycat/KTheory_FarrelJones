...
Before `FJ93`, a useful payload had to supply one exact project object, such
as:
...
Resolved by accepted payload `PAY-T001-CAND005-ROUTE-PRIORART-2026-001`.
`FJ93` performs the bounded known-route / prior-art blocker audit and records
no current repository route or prior-art blocker for `CAND-T001-005`.

## OQ-115. Which accepted payload, if any, should instantiate FJ94 after the FJ93 known-route / prior-art blocker audit?
...
`FJ93` audits the named repository routes for `CAND-T001-005` and finds no
recorded hyperbolic, CAT(0), virtually solvable, finite-index/`FJCw`,
finite-rank free-by-cyclic, hyperbolic-by-cyclic, graph-of-abelian-groups,
...
- FJ83 weaker \(K_0\) / Cohen--Lyndon hypothesis package;
- formulation comparison tied to a named route;
...
`ledgers/payload_intake_protocol.md`, `OBL-C5-014`, `OBL-T001-021`,
`CAND-T001-005`, `ledgers/t001_candidate_inventory.md`,
`ledgers/t001_residual.md`, `ledgers/theorem_dependencies.md`,
`NOTATION_LEDGER.md`, and `AGENTS.md`.
...
by `FJ102` for payload `PAY-T001-CAND-C6-002-2026-001`, by `FJ103` for
payload `PAY-T001-CAND-C6-003-2026-001`, and by `FJ104` for payload
`PAY-T001-CAND-C6-004-2026-001`, and by `FJ105` for payload
`PAY-T001-CAND-C6-005-2026-001`, and by `FJ106` for payload
`PAY-T001-CAND-C6-006-2026-001`, and by `FJ107` for payload
`PAY-T001-CAND-C6-007-2026-001`, and by `FJ108` for payload
`PAY-T001-CAND-C6-008-2026-001`, and by `FJ109` for payload
`PAY-T001-CAND-C6-009-2026-001`, and by `FJ110` for payload
`PAY-T001-CAND-C6-010-2026-001`, and by `FJ111` for payload
`PAY-T001-CAND-C6-011-2026-001`, and by `FJ112` for payload
`PAY-T001-CAND-C6-012-2026-001`, and by `FJ113` for payload
`PAY-T001-CAND-C6-013-2026-001`, and by `FJ114` for payload
`PAY-T001-CAND-C6-014-2026-001`, and by `FJ115` for payload
...
`PAY-T001-CAND-C6-019-2026-001`, and by `FJ120` for payload
`PAY-T001-CAND-C6-020-2026-001`, and by `FJ121` for payload
`PAY-T001-CAND-C6-021-2026-001`, and by `FJ122` for payload
`PAY-T001-CAND-C6-022-2026-001`, and by `FJ123` for payload
`PAY-T001-CAND-C6-023-2026-001`, and by `FJ124` for payload
`PAY-T001-CAND-C6-024-2026-001`, and by `FJ125` for payload
`PAY-T001-CAND-C6-025-2026-001`, and by `FJ126` for payload
`PAY-T001-CAND-C6-026-2026-001`, and by `FJ127` for payload
`PAY-T001-CAND-C6-027-2026-001`, and by `FJ128` for payload
`PAY-T001-CAND-C6-028-2026-001`, and by `FJ129` for payload
`PAY-T001-CAND-C6-029-2026-001`, and by `FJ130` for payload
`PAY-T001-CAND-C6-030-2026-001`, by `FJ131` for payload
`PAY-T001-CAND-C6-031-2026-001`, and by `FJ132` for payload
`PAY-T001-CAND-C6-032-2026-001`, and by `FJ133` for payload
`PAY-T001-CAND-C6-033-2026-001`, by `FJ134` for payload
`PAY-T001-CAND-C6-034-2026-001`, by `FJ135` for payload
`PAY-T001-CAND-C6-035-2026-001`, by `FJ136` for payload
`PAY-T001-CAND-C6-036-2026-001`, by `FJ137` for payload
`PAY-T001-CAND-C6-037-2026-001`, and by `FJ138` for payload
`PAY-T001-CAND-C6-038-2026-001` only; callback queue remains active for
later rows.
...
`FJ117`, `FJ118`, `FJ119`, `FJ120`, `FJ121`, `FJ122`, `FJ123`, `FJ124`,
`FJ125`, `FJ126`, `FJ127`, `FJ128`, `FJ129`, `FJ130`, `FJ131`, `FJ132`, `FJ133`, `FJ134`, `FJ135`, `FJ136`, `FJ137`, and `FJ138` have instantiated
the first thirty-eight
...
or completed by their expected repository objects. `FJ101`--`FJ138` later
changed `OQ-126` only for accepted callback rows `001`--`038`.
...
`FJ102` consumed a separate callback-queue row and does not resolve this
question for `CAND-T001-C6-001`.

## OQ-128. Which accepted payload, if any, should act on CAND-T001-C6-002 after FJ102?
...
`CAND-T001-C6-002` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-005`.
...
## OQ-130. Which accepted payload, if any, should act on CAND-T001-C6-004 after FJ104?
...
`CAND-T001-C6-004` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-007`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-004`.

## OQ-131. Which accepted payload, if any, should act on CAND-T001-C6-005 after FJ105?
...
`CAND-T001-C6-005` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ104`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-008`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-005`.

## OQ-132. Which accepted payload, if any, should act on CAND-T001-C6-006 after FJ106?
...
`CAND-T001-C6-006` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ105`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-009`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-006`.

## OQ-133. Which accepted payload, if any, should act on CAND-T001-C6-007 after FJ107?
...
`CAND-T001-C6-007` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ106`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-010`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-007`.

## OQ-134. Which accepted payload, if any, should act on CAND-T001-C6-008 after FJ108?
...
`CAND-T001-C6-008` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ107`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-011`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-008`.

## OQ-135. Which accepted payload, if any, should act on CAND-T001-C6-009 after FJ109?
...
`CAND-T001-C6-009` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ108`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-012`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-009`.

## OQ-136. Which accepted payload, if any, should act on CAND-T001-C6-010 after FJ110?
...
`CAND-T001-C6-010` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ110`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-013`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-010`.

## OQ-137. Which accepted payload, if any, should act on CAND-T001-C6-011 after FJ111?
...
`CAND-T001-C6-011` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ111`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-014`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-011`.

## OQ-138. Which accepted payload, if any, should act on CAND-T001-C6-012 after FJ112?
...
`CAND-T001-C6-012` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ112`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-015`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-012`.

## OQ-139. Which accepted payload, if any, should act on CAND-T001-C6-013 after FJ113?
...
`CAND-T001-C6-013` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ113`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-016`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-013`.

## OQ-140. Which accepted payload, if any, should act on CAND-T001-C6-014 after FJ114?
...
`CAND-T001-C6-014` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ114`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-017`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-014`.

## OQ-141. Which accepted payload, if any, should act on CAND-T001-C6-015 after FJ115?
...
`CAND-T001-C6-015` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ115`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-018`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-015`.

## OQ-142. Which accepted payload, if any, should act on CAND-T001-C6-016 after FJ116?
...
`CAND-T001-C6-016` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ116`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-019`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-016`.

## OQ-143. Which accepted payload, if any, should act on CAND-T001-C6-017 after FJ117?
...
`CAND-T001-C6-017` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ117`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-020`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-017`.

## OQ-144. Which accepted payload, if any, should act on CAND-T001-C6-018 after FJ118?
...
`CAND-T001-C6-018` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ118`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-021`.
...
## OQ-146. Which accepted payload, if any, should act on CAND-T001-C6-020 after FJ120?
...
`CAND-T001-C6-020` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ120`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-023`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-020`.

## OQ-147. Which accepted payload, if any, should act on CAND-T001-C6-021 after FJ121?
...
`CAND-T001-C6-021` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ121`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-024`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-021`.

## OQ-148. Which accepted payload, if any, should act on CAND-T001-C6-022 after FJ122?
...
`CAND-T001-C6-022` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ122`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-025`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-022`.

## OQ-149. Which accepted payload, if any, should act on CAND-T001-C6-023 after FJ123?
...
`CAND-T001-C6-023` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ123`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-026`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-023`.

## OQ-150. Which accepted payload, if any, should act on CAND-T001-C6-024 after FJ124?
...
`CAND-T001-C6-024` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ124`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-027`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-024`.

## OQ-151. Which accepted payload, if any, should act on CAND-T001-C6-025 after FJ125?
...
`CAND-T001-C6-025` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ125`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-028`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-025`.

## OQ-152. Which accepted payload, if any, should act on CAND-T001-C6-026 after FJ126?
...
`CAND-T001-C6-026` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ126`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-029`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-026`.

## OQ-153. Which accepted payload, if any, should act on CAND-T001-C6-027 after FJ127?
...
`CAND-T001-C6-027` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ127`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-030`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-027`.

## OQ-154. Which accepted payload, if any, should act on CAND-T001-C6-028 after FJ128?
...
`CAND-T001-C6-028` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ128`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-031`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-028`.

## OQ-155. Which accepted payload, if any, should act on CAND-T001-C6-029 after FJ129?
...
`CAND-T001-C6-029` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ129`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-032`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-029`.

## OQ-156. Which accepted payload, if any, should act on CAND-T001-C6-030 after FJ130?
...
`CAND-T001-C6-030` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ130`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-033`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-030`.

## OQ-157. Which accepted payload, if any, should act on CAND-T001-C6-031 after FJ131?
...
`CAND-T001-C6-031` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ131`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-034`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-031`.

## OQ-158. Which accepted payload, if any, should act on CAND-T001-C6-032 after FJ132?
...
`CAND-T001-C6-032` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ132`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-035`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-032`.

## OQ-159. Which accepted payload, if any, should act on CAND-T001-C6-033 after FJ133?
...
`CAND-T001-C6-033` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ133`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-036`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-033`.

## OQ-160. Which accepted payload, if any, should act on CAND-T001-C6-034 after FJ134?
...
`CAND-T001-C6-034` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ134`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-037`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-034`.

## OQ-161. Which accepted payload, if any, should act on CAND-T001-C6-035 after FJ135?
...
`CAND-T001-C6-035` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ135`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-038`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-035`.

## OQ-162. Which accepted payload, if any, should act on CAND-T001-C6-036 after FJ136?
...
`CAND-T001-C6-036` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ136`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-039`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-036`.

## OQ-163. Which accepted payload, if any, should act on CAND-T001-C6-037 after FJ137?
...
`CAND-T001-C6-037` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ137`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-040`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-037`.

## OQ-164. Which accepted payload, if any, should act on CAND-T001-C6-038 after FJ138?
...
`CAND-T001-C6-038` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ138`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-041`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-038`.

## OQ-165. Which accepted payload, if any, should act on CAND-T001-C6-039 after FJ139?
...
`CAND-T001-C6-039` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ139`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-042`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-039`.

## OQ-166. Which accepted payload, if any, should act on CAND-T001-C6-040 after FJ140?
...
`CAND-T001-C6-040` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ140`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-043`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-040`.

## OQ-167. Which accepted payload, if any, should act on CAND-T001-C6-041 after FJ141?
...
`CAND-T001-C6-041` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ141`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-044`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-041`.


## OQ-168. Which accepted payload, if any, should act on CAND-T001-C6-042 after FJ142?
...
`CAND-T001-C6-042` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ142`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-045`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-042`.

## OQ-169. Which accepted payload, if any, should act on CAND-T001-C6-043 after FJ143?
...
`CAND-T001-C6-043` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ143`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-046`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-043`.
## OQ-170. Which accepted payload, if any, should act on CAND-T001-C6-044 after FJ144?
...
`CAND-T001-C6-044` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ144`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-047`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-044`.
## OQ-171. Which accepted payload, if any, should act on CAND-T001-C6-045 after FJ145?
...
`CAND-T001-C6-045` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ145`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-048`.
...
## OQ-173. Which accepted payload, if any, should act on CAND-T001-C6-047 after FJ147?
...
`CAND-T001-C6-047` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ147`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-050`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-047`.
## OQ-174. Which accepted payload, if any, should act on CAND-T001-C6-048 after FJ148?
...
`CAND-T001-C6-048` as a concrete torsion-free one-relator candidate at
first-pass intake level. The row has a non-proper-power relator check, an
epimorphism \(\chi(a)=1,\chi(b)=0\), and first-pass torsion-free status via
the existing Putman source-status row used in `FJ91` and reused in
`FJ101`--`FJ148`.
...
`ledgers/payload_execution_queue.md`, `ledgers/payload_intake_protocol.md`,
`ledgers/t001_candidate_inventory.md`, `ledgers/t001_residual.md`,
`ledgers/theorem_dependencies.md`, and `OBL-C6-051`.
...
blocker audit, formulation comparison, route bridge, or branch decision.
The callback queue may continue to add separate candidate-intake rows, but a
future row does not by itself resolve this question for `CAND-T001-C6-048`.
