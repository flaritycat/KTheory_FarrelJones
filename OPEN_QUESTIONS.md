...
`FJ55` resolved `OQ-076`; continue with `OQ-077`/`FJ56`.
...
bridge test; continue with `OQ-077`/`FJ56`.
...
attack packet; `FJ55` resolves `OQ-076`; continue with `OQ-077`/`FJ56`.
...
checkpoint, and `FJ55` resolves `OQ-076`; continue with `OQ-077`/`FJ56`.
...
Resolved by `FJ54`. `FJ55` resolves revised `OQ-076`; continue with
`OQ-077`/`FJ56`.
...
Resolved by `FJ55`. Continue with `OQ-077`/`FJ56`.

## OQ-077. Which candidate rows can receive kernel-control data?

### Status

Open inside project; generated by `FJ55` and selected for `FJ56`.
