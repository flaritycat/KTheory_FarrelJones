...
`PAY-T001-CAND-C6-027-2026-001` only; callback queue remains active for
later rows.
...
`FJ125`, `FJ126`, and `FJ127` have instantiated the first twenty-seven
...
or completed by their expected repository objects. `FJ101`--`FJ127` later
changed `OQ-126` only for accepted callback rows `001`--`027`.
