...
| FJ06 infinite cyclic group example | FJ01 simplified assembly map; FJ03 classifying spaces; FJ04 virtually cyclic structure | not started | Needs source check before invoking Bass--Heller--Swan or Nil-term statements. |
