...
| FJ09 projective class group consequence | FJ08 \(\mathrm{Wh}_0^R(G)\) framework; source for projective class group notation and hypotheses | not started | Should separate \(\widetilde K_0(\mathbb Z[G])\) from broader projective class group conventions. |
