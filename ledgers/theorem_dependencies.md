...
| FJ14 CAT(0)-groups case | FJ11 CAT(0)-groups row; Wegner source; Bartels--Lueck L-theory source if needed | not started | Should distinguish Wegner's K-theory theorem from Bartels--Lueck's L-theory result and avoid importing CAT(0) proof machinery prematurely. |
