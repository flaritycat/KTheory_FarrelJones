...
| FJ11 known classes ledger | Sources for known Farrell--Jones cases | not started | Must separate theorem statements, coefficient versions, and inheritance closures. |
