...
| `PAY-T001-CAND-C6-006-2026-001` | `PAY-T001-CAND` | accepted for `FJ106` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-006`; consumes callback queue row `006` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-007-2026-001` | `PAY-T001-CAND` | accepted for `FJ107` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-007`; consumes callback queue row `007` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-008-2026-001` | `PAY-T001-CAND` | accepted for `FJ108` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-008`; consumes callback queue row `008` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-009-2026-001` | `PAY-T001-CAND` | accepted for `FJ109` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-009`; consumes callback queue row `009` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-010-2026-001` | `PAY-T001-CAND` | accepted for `FJ110` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-010`; consumes callback queue row `010` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-011-2026-001` | `PAY-T001-CAND` | accepted for `FJ111` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-011`; consumes callback queue row `011` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-012-2026-001` | `PAY-T001-CAND` | accepted for `FJ112` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-012`; consumes callback queue row `012` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-013-2026-001` | `PAY-T001-CAND` | accepted for `FJ113` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-013`; consumes callback queue row `013` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-014-2026-001` | `PAY-T001-CAND` | accepted for `FJ114` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-014`; consumes callback queue row `014` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-015-2026-001` | `PAY-T001-CAND` | accepted for `FJ115` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-015`; consumes callback queue row `015` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-016-2026-001` | `PAY-T001-CAND` | accepted for `FJ116` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-016`; consumes callback queue row `016` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-017-2026-001` | `PAY-T001-CAND` | accepted for `FJ117` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-017`; consumes callback queue row `017` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-018-2026-001` | `PAY-T001-CAND` | accepted for `FJ118` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-018`; consumes callback queue row `018` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-019-2026-001` | `PAY-T001-CAND` | accepted for `FJ119` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-019`; consumes callback queue row `019` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-020-2026-001` | `PAY-T001-CAND` | accepted for `FJ120` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-020`; consumes callback queue row `020` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
...
| `PAY-T001-CAND-C6-025-2026-001` | `PAY-T001-CAND` | accepted for `FJ125` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-025`; consumes callback queue row `025` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-026-2026-001` | `PAY-T001-CAND` | accepted for `FJ126` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-026`; consumes callback queue row `026` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-027-2026-001` | `PAY-T001-CAND` | accepted for `FJ127` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-027`; consumes callback queue row `027` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-028-2026-001` | `PAY-T001-CAND` | accepted for `FJ128` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-028`; consumes callback queue row `028` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-029-2026-001` | `PAY-T001-CAND` | accepted for `FJ129` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-029`; consumes callback queue row `029` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-030-2026-001` | `PAY-T001-CAND` | accepted for `FJ130` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-030`; consumes callback queue row `030` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-031-2026-001` | `PAY-T001-CAND` | accepted for `FJ131` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-031`; consumes callback queue row `031` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-032-2026-001` | `PAY-T001-CAND` | accepted for `FJ132` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-032`; consumes callback queue row `032` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-033-2026-001` | `PAY-T001-CAND` | accepted for `FJ133` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-033`; consumes callback queue row `033` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-034-2026-001` | `PAY-T001-CAND` | accepted for `FJ134` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-034`; consumes callback queue row `034` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-035-2026-001` | `PAY-T001-CAND` | accepted for `FJ135` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-035`; consumes callback queue row `035` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-036-2026-001` | `PAY-T001-CAND` | accepted for `FJ136` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-036`; consumes callback queue row `036` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
...
| `PAY-T001-CAND-C6-046-2026-001` | `PAY-T001-CAND` | accepted for `FJ146` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-046`; consumes callback queue row `046` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-047-2026-001` | `PAY-T001-CAND` | accepted for `FJ147` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-047`; consumes callback queue row `047` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
| `PAY-T001-CAND-C6-048-2026-001` | `PAY-T001-CAND` | accepted for `FJ148` only | Concrete two-generator one-relator candidate-intake payload for `CAND-T001-C6-048`; consumes callback queue row `048` only for the bounded candidate-intake audit and does not claim Farrell-Jones, route promotion, residual subtraction, prior art, or theorem novelty. |
...
`FJ106` consumes only queue row `006`, adds `CAND-T001-C6-006` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-132` and `OBL-C6-009`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ107` consumes only queue row `007`, adds `CAND-T001-C6-007` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-133` and `OBL-C6-010`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ108` consumes only queue row `008`, adds `CAND-T001-C6-008` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-134` and `OBL-C6-011`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ109` consumes only queue row `009`, adds `CAND-T001-C6-009` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-135` and `OBL-C6-012`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ110` consumes only queue row `010`, adds `CAND-T001-C6-010` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-136` and `OBL-C6-013`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ111` consumes only queue row `011`, adds `CAND-T001-C6-011` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-137` and `OBL-C6-014`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ112` consumes only queue row `012`, adds `CAND-T001-C6-012` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-138` and `OBL-C6-015`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ113` consumes only queue row `013`, adds `CAND-T001-C6-013` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-139` and `OBL-C6-016`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ114` consumes only queue row `014`, adds `CAND-T001-C6-014` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-140` and `OBL-C6-017`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ115` consumes only queue row `015`, adds `CAND-T001-C6-015` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-141` and `OBL-C6-018`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ116` consumes only queue row `016`, adds `CAND-T001-C6-016` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-142` and `OBL-C6-019`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ117` consumes only queue row `017`, adds `CAND-T001-C6-017` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-143` and `OBL-C6-020`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ118` consumes only queue row `018`, adds `CAND-T001-C6-018` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-144` and `OBL-C6-021`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ119` consumes only queue row `019`, adds `CAND-T001-C6-019` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-145` and `OBL-C6-022`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ120` consumes only queue row `020`, adds `CAND-T001-C6-020` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-146` and `OBL-C6-023`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ121` consumes only queue row `021`, adds `CAND-T001-C6-021` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-147` and `OBL-C6-024`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ122` consumes only queue row `022`, adds `CAND-T001-C6-022` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-148` and `OBL-C6-025`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.
...
`FJ125` consumes only queue row `025`, adds `CAND-T001-C6-025` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-151` and `OBL-C6-028`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ126` consumes only queue row `026`, adds `CAND-T001-C6-026` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-152` and `OBL-C6-029`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ127` consumes only queue row `027`, adds `CAND-T001-C6-027` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-153` and `OBL-C6-030`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ128` consumes only queue row `028`, adds `CAND-T001-C6-028` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-154` and `OBL-C6-031`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ129` consumes only queue row `029`, adds `CAND-T001-C6-029` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-155` and `OBL-C6-032`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ130` consumes only queue row `030`, adds `CAND-T001-C6-030` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-156` and `OBL-C6-033`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ131` consumes only queue row `031`, adds `CAND-T001-C6-031` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-157` and `OBL-C6-034`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ132` consumes only queue row `032`, adds `CAND-T001-C6-032` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-158` and `OBL-C6-035`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ133` consumes only queue row `033`, adds `CAND-T001-C6-033` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-159` and `OBL-C6-036`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ134` consumes only queue row `034`, adds `CAND-T001-C6-034` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-160` and `OBL-C6-037`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.
...
`FJ135` consumes only queue row `035`, adds `CAND-T001-C6-035` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-161` and `OBL-C6-038`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ136` consumes only queue row `036`, adds `CAND-T001-C6-036` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-162` and `OBL-C6-039`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ137` consumes only queue row `037`, adds `CAND-T001-C6-037` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-163` and `OBL-C6-040`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ138` consumes only queue row `038`, adds `CAND-T001-C6-038` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
...
`FJ140` consumes only queue row `040`, adds `CAND-T001-C6-040` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
queue row completed, creates `OQ-166` and `OBL-C6-043`, and makes no
Farrell--Jones route claim, theorem promotion, weaker \(K_0\) claim,
prior-art claim, or residual subtraction.

`FJ141` consumes only queue row `041`, adds `CAND-T001-C6-041` as a
candidate-admissible but route-unresolved first-pass intake row, marks that
...
### PAY-T001-CAND-C6-043-2026-001

`FJ143` consumes callback queue row `043` for `CAND-T001-C6-043` only. It creates `OQ-169` and `OBL-C6-046`, records no Farrell--Jones route, theorem promotion, weaker \(K_0\) consequence, prior-art blocker, or residual subtraction, and stops before row `044`.
...
### PAY-T001-CAND-C6-046-2026-001

`FJ146` consumes callback queue row `046` for `CAND-T001-C6-046` only. It creates `OQ-172` and `OBL-C6-049`, records no Farrell--Jones route, theorem promotion, weaker \(K_0\) consequence, prior-art blocker, or residual subtraction, and stops before row `047`.

### PAY-T001-CAND-C6-047-2026-001

`FJ147` consumes callback queue row `047` for `CAND-T001-C6-047` only. It creates `OQ-173` and `OBL-C6-050`, records no Farrell--Jones route, theorem promotion, weaker \(K_0\) consequence, prior-art blocker, or residual subtraction, and stops before row `048`.

### PAY-T001-CAND-C6-048-2026-001

`FJ148` consumes callback queue row `048` for `CAND-T001-C6-048` only. It creates `OQ-174` and `OBL-C6-051`, records no Farrell--Jones route, theorem promotion, weaker \(K_0\) consequence, prior-art blocker, or residual subtraction, and stops before row `049`.
