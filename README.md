...
- Active cycle: post-`cycle_005` review gate; `cycle_006` has not opened.
...
- Current active project status: post-`cycle_005` reflection / post-100-module
  review gate. `reflections/cycle_005_reflection.md` closes `cycle_005` and
  selects the post-100-module strategic review as the next governance move.
- Current procedural target: execute `next_prompts.md`, Prompt 022, as a
  post-100-module strategic review unless a higher-priority accepted payload
  is recorded.
