...
- Current procedural target: begin `FJ57`, Candidate Family Proof Attempt or Obstruction Record for the `RB-003` + `RB-004`/`RB-008` hybrid attack packet.
