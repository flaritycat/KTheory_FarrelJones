...
- Current active project status: cycle-006 has opened only as a
  ...
  `FJ122` consumed row `022`, `FJ123` consumed row `023`, and `FJ124`
  consumed row `024`, and none
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-024`, and the callback queue discipline for later row intake.
