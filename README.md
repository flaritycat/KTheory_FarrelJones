...
- Current active project status: cycle-006 has opened only as a
  ...
  `FJ129` consumed row `029`, and `FJ130` consumed row `030`, and none
  creates a route, theorem, or residual subtraction.
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-030`, and the callback queue discipline for later row intake.
