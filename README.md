...
- Current active project status: post-`FJ92` Brown/BNS kernel-control gate.
  `FJ92` was instantiated by accepted computation payload
  `PAY-T001-CAND005-BROWN-BNS-2026-001`.
- Current procedural target: no numbered module is selected; instantiate
  `FJ93` only after a new accepted payload is recorded in
