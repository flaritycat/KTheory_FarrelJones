...
- Current active project status: cycle-006 has opened only as a
  ...
  `009`, `FJ110` consumed row `010`, `FJ111` consumed row `011`, and none
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-011`, and the callback queue discipline for later row intake.
