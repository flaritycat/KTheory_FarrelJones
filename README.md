...
- Current active project status: cycle-006 has opened only as a
  ...
  `014`, `FJ115` consumed row `015`, and none creates a route, theorem, or
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-015`, and the callback queue discipline for later row intake.
