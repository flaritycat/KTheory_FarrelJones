...
- Current active bounded target packet: `A-004`, target-pivot refresh after the Artin pause.
- Current procedural target: begin `FJ72`, Target-Pivot Refresh After Artin Pause.
