...
- Current active project status: cycle-006 has opened only as a
  ...
  `004`, `FJ105` consumed row `005`, and none creates a route, theorem, or
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-005`, and the callback queue discipline for later row intake.
