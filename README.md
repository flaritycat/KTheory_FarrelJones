...
- Current active project status: cycle-006 has opened only as a
  ...
  consumed row `002`, `FJ103` consumed row `003`, and none creates a route,
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-003`, and the callback queue discipline for later row intake.
