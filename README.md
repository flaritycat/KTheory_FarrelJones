...
- Current active project status: cycle-006 has opened only as a
  ...
  consumed row `024`, `FJ125` consumed row `025`, and `FJ126` consumed
  row `026`, and none
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-026`, and the callback queue discipline for later row intake.
