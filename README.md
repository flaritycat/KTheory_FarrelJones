...
- Current active project status: cycle-006 has opened only as a
  ...
  row `026`, and `FJ127` consumed row `027`, and none
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-027`, and the callback queue discipline for later row intake.
