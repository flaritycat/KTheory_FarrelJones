...
- Current active bounded target packet: `A-003`, Artin branch checkpoint after the Wu filter.
- Current procedural target: begin `FJ71`, Artin Branch Checkpoint After Wu Filter.
