...
- Current active project status: cycle-006 has opened only as a
  ...
  `019`, and `FJ120` consumed row `020`, and none creates a route, theorem,
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-020`, and the callback queue discipline for later row intake.
