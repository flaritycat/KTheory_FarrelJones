...
- Current active project status: cycle-006 has opened only as a
  ...
  `033`, and `FJ134` consumed row `034`, and none creates a route, theorem,
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-034`, and the callback queue discipline for later row intake.
