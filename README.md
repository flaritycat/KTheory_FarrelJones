...
- Current active project status: cycle-006 has opened only as a
  ...
  row `026`, `FJ127` consumed row `027`, `FJ128` consumed row `028`, and
  `FJ129` consumed row `029`, and none
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-029`, and the callback queue discipline for later row intake.
