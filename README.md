...
- Current active project status: post-`FJ90` candidate-intake gate. `FJ90`
  was instantiated by accepted candidate payload
  `PAY-T001-CAND-FJ90-2026-001`.
- Current procedural target: no numbered module is selected; instantiate
  `FJ91` only after a new accepted payload is recorded in
