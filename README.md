...
- Current active project status: cycle-006 has opened only as a
  ...
  `014`, `FJ115` consumed row `015`, `FJ116` consumed row `016`, and none
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-016`, and the callback queue discipline for later row intake.
