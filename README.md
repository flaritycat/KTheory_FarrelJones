...
- Current active project status: cycle-006 has opened only as a
  ...
  `004`, `FJ105` consumed row `005`, `FJ106` consumed row `006`, and none
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-006`, and the callback queue discipline for later row intake.
