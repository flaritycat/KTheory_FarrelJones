...
- Current active project status: cycle-006 has opened only as a
  ...
  `009`, `FJ110` consumed row `010`, and none creates a route, theorem, or
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-010`, and the callback queue discipline for later row intake.
