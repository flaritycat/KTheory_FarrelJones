...
- Current active project status: cycle-006 has opened only as a
  ...
  consumed row `031`, and `FJ132` consumed row `032`, and none creates a
...
- Active gates: `OQ-127` / `OBL-C6-004` for follow-up work on
  ...
  `CAND-T001-C6-032`, and the callback queue discipline for later row intake.
