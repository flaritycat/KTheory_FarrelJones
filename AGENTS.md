...
- `OQ-126` is resolved only for the accepted row-001 through row-030
  payloads that created `FJ101`--`FJ130`.
...
- `OBL-C5-021`: post-FJ100 prompt-backlog maintenance / reflection
  ...
  accepted callback rows 001--030.
...
- `OBL-C6-003`: completed only for accepted callback rows 001--030, which
  instantiated `FJ101`--`FJ130`. Template prompts and generic continuation
