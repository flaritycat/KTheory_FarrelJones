...
- `OQ-126` is resolved only for the accepted row-001 through row-015
  payloads that created `FJ101`--`FJ115`.
...
- `OBL-C5-021`: post-FJ100 prompt-backlog maintenance / reflection
  ...
  accepted callback rows 001--015.
...
- `OBL-C6-003`: completed only for accepted callback rows 001--015, which
  instantiated `FJ101`--`FJ115`. Template prompts and generic continuation
