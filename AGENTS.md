...
- `OQ-126` is resolved only for the accepted row-001 through row-027
  payloads that created `FJ101`--`FJ127`.
...
- `OBL-C5-021`: post-FJ100 prompt-backlog maintenance / reflection
  ...
  accepted callback rows 001--027.
...
- `OBL-C6-003`: completed only for accepted callback rows 001--027, which
  instantiated `FJ101`--`FJ127`. Template prompts and generic continuation
