...
Persistent instructions for future Codex runs in this repository.
...
- `RB-006` is demoted / provisionally non-subtractive because the current
  Louder--Wilton / negative-immersion path appears to overlap known
  hyperbolic routes.
- Every new FJ module must change at least one of:
  - candidate inventory;
  - residual-bucket status;
  - open-question status;
  - proof obligation;
  - prior-art blocker list.
- Source summaries alone are not enough.
- When adding a theorem claim, record the exact theorem source, hypotheses,
  formulation used, and source-status label.
- When uncertain, mark the item unresolved rather than promoting it.
...
- `FJ102`: instantiated only from accepted callback-queue row
  ...
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ103`: instantiated only from accepted callback-queue row
...
- `FJ104`: instantiated only from accepted callback-queue row
  ...
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ105`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-005-2026-001`. It adds `CAND-T001-C6-005` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ106`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-006-2026-001`. It adds `CAND-T001-C6-006` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ107`: instantiated only from accepted callback-queue row
...
- `FJ108`: instantiated only from accepted callback-queue row
  ...
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ109`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-009-2026-001`. It adds `CAND-T001-C6-009` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ110`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-010-2026-001`. It adds `CAND-T001-C6-010` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ111`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-011-2026-001`. It adds `CAND-T001-C6-011` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ112`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-012-2026-001`. It adds `CAND-T001-C6-012` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ113`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-013-2026-001`. It adds `CAND-T001-C6-013` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ114`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-014-2026-001`. It adds `CAND-T001-C6-014` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ115`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-015-2026-001`. It adds `CAND-T001-C6-015` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ116`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-016-2026-001`. It adds `CAND-T001-C6-016` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ117`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-017-2026-001`. It adds `CAND-T001-C6-017` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ118`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-018-2026-001`. It adds `CAND-T001-C6-018` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ119`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-019-2026-001`. It adds `CAND-T001-C6-019` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ120`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-020-2026-001`. It adds `CAND-T001-C6-020` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ121`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-021-2026-001`. It adds `CAND-T001-C6-021` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ122`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-022-2026-001`. It adds `CAND-T001-C6-022` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ123`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-023-2026-001`. It adds `CAND-T001-C6-023` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ124`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-024-2026-001`. It adds `CAND-T001-C6-024` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ125`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-025-2026-001`. It adds `CAND-T001-C6-025` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ126`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-026-2026-001`. It adds `CAND-T001-C6-026` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ127`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-027-2026-001`. It adds `CAND-T001-C6-027` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ128`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-028-2026-001`. It adds `CAND-T001-C6-028` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ129`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-029-2026-001`. It adds `CAND-T001-C6-029` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ130`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-030-2026-001`. It adds `CAND-T001-C6-030` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ131`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-031-2026-001`. It adds `CAND-T001-C6-031` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ132`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-032-2026-001`. It adds `CAND-T001-C6-032` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ133`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-033-2026-001`. It adds `CAND-T001-C6-033` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ134`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-034-2026-001`. It adds `CAND-T001-C6-034` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ135`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-035-2026-001`. It adds `CAND-T001-C6-035` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ136`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-036-2026-001`. It adds `CAND-T001-C6-036` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ137`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-037-2026-001`. It adds `CAND-T001-C6-037` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ138`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-038-2026-001`. It adds `CAND-T001-C6-038` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
...
- `FJ139`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-039-2026-001`. It adds `CAND-T001-C6-039` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ140`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-040-2026-001`. It adds `CAND-T001-C6-040` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ141`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-041-2026-001`. It adds `CAND-T001-C6-041` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ142`: instantiated only from accepted callback-queue row
...
- `FJ143`: instantiated only from accepted callback-queue row
  ...
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ144`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-044-2026-001`. It adds `CAND-T001-C6-044` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ145`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-045-2026-001`. It adds `CAND-T001-C6-045` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ146`: instantiated only from accepted callback-queue row
...
- `FJ147`: instantiated only from accepted callback-queue row
  ...
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `FJ148`: instantiated only from accepted callback-queue row
  `PAY-T001-CAND-C6-048-2026-001`. It adds `CAND-T001-C6-048` as a
  candidate-admissible but route-unresolved intake row and makes no route,
  theorem, prior-art, weaker \(K_0\), or residual-subtraction claim.
- `OQ-126` is resolved only for the accepted row-001 through row-048
  payloads that created `FJ101`--`FJ148`.
...
- `OQ-130` and `OBL-C6-007` now govern follow-up work on
  `CAND-T001-C6-004`.
- `OQ-131` and `OBL-C6-008` now govern follow-up work on
  `CAND-T001-C6-005`.
- `OQ-132` and `OBL-C6-009` now govern follow-up work on
  `CAND-T001-C6-006`.
- `OQ-133` and `OBL-C6-010` now govern follow-up work on
  `CAND-T001-C6-007`.
- `OQ-134` and `OBL-C6-011` now govern follow-up work on
  `CAND-T001-C6-008`.
- `OQ-135` and `OBL-C6-012` now govern follow-up work on
  `CAND-T001-C6-009`.
- `OQ-136` and `OBL-C6-013` now govern follow-up work on
  `CAND-T001-C6-010`.
- `OQ-137` and `OBL-C6-014` now govern follow-up work on
  `CAND-T001-C6-011`.
- `OQ-138` and `OBL-C6-015` now govern follow-up work on
  `CAND-T001-C6-012`.
- `OQ-139` and `OBL-C6-016` now govern follow-up work on
  `CAND-T001-C6-013`.
- `OQ-140` and `OBL-C6-017` now govern follow-up work on
  `CAND-T001-C6-014`.
- `OQ-141` and `OBL-C6-018` now govern follow-up work on
  `CAND-T001-C6-015`.
- `OQ-142` and `OBL-C6-019` now govern follow-up work on
  `CAND-T001-C6-016`.
- `OQ-143` and `OBL-C6-020` now govern follow-up work on
  `CAND-T001-C6-017`.
- `OQ-144` and `OBL-C6-021` now govern follow-up work on
  `CAND-T001-C6-018`.
- `OQ-145` and `OBL-C6-022` now govern follow-up work on
  `CAND-T001-C6-019`.
- `OQ-146` and `OBL-C6-023` now govern follow-up work on
  `CAND-T001-C6-020`.
- `OQ-147` and `OBL-C6-024` now govern follow-up work on
  `CAND-T001-C6-021`.
- `OQ-148` and `OBL-C6-025` now govern follow-up work on
  `CAND-T001-C6-022`.
- `OQ-149` and `OBL-C6-026` now govern follow-up work on
  `CAND-T001-C6-023`.
- `OQ-150` and `OBL-C6-027` now govern follow-up work on
  `CAND-T001-C6-024`.
- `OQ-151` and `OBL-C6-028` now govern follow-up work on
  `CAND-T001-C6-025`.
- `OQ-152` and `OBL-C6-029` now govern follow-up work on
  `CAND-T001-C6-026`.
- `OQ-153` and `OBL-C6-030` now govern follow-up work on
  `CAND-T001-C6-027`.
- `OQ-154` and `OBL-C6-031` now govern follow-up work on
  `CAND-T001-C6-028`.
- `OQ-155` and `OBL-C6-032` now govern follow-up work on
  `CAND-T001-C6-029`.
- `OQ-156` and `OBL-C6-033` now govern follow-up work on
  `CAND-T001-C6-030`.
- `OQ-157` and `OBL-C6-034` now govern follow-up work on
  `CAND-T001-C6-031`.
- `OQ-158` and `OBL-C6-035` now govern follow-up work on
  `CAND-T001-C6-032`.
- `OQ-159` and `OBL-C6-036` now govern follow-up work on
  `CAND-T001-C6-033`.
- `OQ-160` and `OBL-C6-037` now govern follow-up work on
  `CAND-T001-C6-034`.
- `OQ-161` and `OBL-C6-038` now govern follow-up work on
  `CAND-T001-C6-035`.
- `OQ-162` and `OBL-C6-039` now govern follow-up work on
  `CAND-T001-C6-036`.
- `OQ-163` and `OBL-C6-040` now govern follow-up work on
  `CAND-T001-C6-037`.
- `OQ-164` and `OBL-C6-041` now govern follow-up work on
  `CAND-T001-C6-038`.
- `OQ-165` and `OBL-C6-042` now govern follow-up work on
  `CAND-T001-C6-039`.
- `OQ-166` and `OBL-C6-043` now govern follow-up work on
  `CAND-T001-C6-040`.
- `OQ-167` and `OBL-C6-044` now govern follow-up work on
  `CAND-T001-C6-041`.
- `OQ-168` and `OBL-C6-045` now govern follow-up work on
  `CAND-T001-C6-042`.
- `OQ-169` and `OBL-C6-046` now govern follow-up work on
  `CAND-T001-C6-043`.
- `OQ-170` and `OBL-C6-047` now govern follow-up work on
  `CAND-T001-C6-044`.
- `OQ-171` and `OBL-C6-048` now govern follow-up work on
  `CAND-T001-C6-045`.
- `OQ-172` and `OBL-C6-049` now govern follow-up work on
  `CAND-T001-C6-046`.
- `OQ-173` and `OBL-C6-050` now govern follow-up work on
  `CAND-T001-C6-047`.
- `OQ-174` and `OBL-C6-051` now govern follow-up work on
  `CAND-T001-C6-048`.
...
- `OBL-T001-006`: no weaker \(K_0\) / Cohen--Lyndon source payload is
  currently recorded for `T-001`. `FJ60` closed the lane rather than
  selecting a payload.
...
- `OBL-C6-047`: active after `FJ144`. Do not promote or route
  `CAND-T001-C6-044` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-048`: active after `FJ145`. Do not promote or route
  `CAND-T001-C6-045` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
...
- `OBL-C6-050`: active after `FJ147`. Do not promote or route
  ...
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-051`: active after `FJ148`. Do not promote or route
  `CAND-T001-C6-048` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
...
- `OBL-C6-045`: active after `FJ142`. Do not promote or route
  `CAND-T001-C6-042` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-044`: active after `FJ141`. Do not promote or route
  `CAND-T001-C6-041` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-043`: active after `FJ140`. Do not promote or route
  `CAND-T001-C6-040` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
...
- `OBL-C6-007`: active after `FJ104`. Do not promote or route
  ...
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-008`: active after `FJ105`. Do not promote or route
  `CAND-T001-C6-005` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-009`: active after `FJ106`. Do not promote or route
  `CAND-T001-C6-006` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
...
- `OBL-C6-011`: active after `FJ108`. Do not promote or route
  ...
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-012`: active after `FJ109`. Do not promote or route
  `CAND-T001-C6-009` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-013`: active after `FJ110`. Do not promote or route
  `CAND-T001-C6-010` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-014`: active after `FJ111`. Do not promote or route
  `CAND-T001-C6-011` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-015`: active after `FJ112`. Do not promote or route
  `CAND-T001-C6-012` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-016`: active after `FJ113`. Do not promote or route
  `CAND-T001-C6-013` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-017`: active after `FJ114`. Do not promote or route
  `CAND-T001-C6-014` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-018`: active after `FJ115`. Do not promote or route
  `CAND-T001-C6-015` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-019`: active after `FJ116`. Do not promote or route
  `CAND-T001-C6-016` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-020`: active after `FJ117`. Do not promote or route
  `CAND-T001-C6-017` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-021`: active after `FJ118`. Do not promote or route
  `CAND-T001-C6-018` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-022`: active after `FJ119`. Do not promote or route
  `CAND-T001-C6-019` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-023`: active after `FJ120`. Do not promote or route
  `CAND-T001-C6-020` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-024`: active after `FJ121`. Do not promote or route
  `CAND-T001-C6-021` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-025`: active after `FJ122`. Do not promote or route
  `CAND-T001-C6-022` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-026`: active after `FJ123`. Do not promote or route
  `CAND-T001-C6-023` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-027`: active after `FJ124`. Do not promote or route
  `CAND-T001-C6-024` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-028`: active after `FJ125`. Do not promote or route
  `CAND-T001-C6-025` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-029`: active after `FJ126`. Do not promote or route
  `CAND-T001-C6-026` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-030`: active after `FJ127`. Do not promote or route
  `CAND-T001-C6-027` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-031`: active after `FJ128`. Do not promote or route
  `CAND-T001-C6-028` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-032`: active after `FJ129`. Do not promote or route
  `CAND-T001-C6-029` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-033`: active after `FJ130`. Do not promote or route
  `CAND-T001-C6-030` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-034`: active after `FJ131`. Do not promote or route
  `CAND-T001-C6-031` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-035`: active after `FJ132`. Do not promote or route
  `CAND-T001-C6-032` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-036`: active after `FJ133`. Do not promote or route
  `CAND-T001-C6-033` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-037`: active after `FJ134`. Do not promote or route
  `CAND-T001-C6-034` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-038`: active after `FJ135`. Do not promote or route
  `CAND-T001-C6-035` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-039`: active after `FJ136`. Do not promote or route
  `CAND-T001-C6-036` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-040`: active after `FJ137`. Do not promote or route
  `CAND-T001-C6-037` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-041`: active after `FJ138`. Do not promote or route
  `CAND-T001-C6-038` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
...
- `OBL-T001-019`: partially completed by `FJ92`. `FJ92` records
  ...
  `FJ26`.
- `OBL-T001-020`: completed for known-route / prior-art audit by `FJ93` and
...
- `OBL-C5-013`: completed by accepted payload
  `PAY-T001-CAND005-ROUTE-PRIORART-2026-001`, which instantiated `FJ93`.
- `OBL-C5-014`: no `FJ94` module may be created until a new accepted payload
  is recorded under `ledgers/payload_intake_protocol.md` or in the relevant
  target ledger. Completed by accepted payload
...
- `OBL-C5-021`: post-FJ100 prompt-backlog maintenance / reflection
  ...
  accepted callback rows 001--044.
...
- `OBL-C6-042`: active after `FJ139`. Do not promote or route
  `CAND-T001-C6-039` until a new accepted payload records a kernel-control
  computation, source-verified route bridge, formulation comparison,
  prior-art blocker, or branch decision.
- `OBL-C6-003`: completed only for accepted callback rows 001--040, which
  instantiated `FJ101`--`FJ140`. Template prompts and generic continuation
...
- External mathematical facts require citations, preferably APA style, and
  source-status updates.
- Do not store private credentials, unlicensed PDFs, or uncited theorem
  claims.
