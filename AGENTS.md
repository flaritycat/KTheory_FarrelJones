...
- `OQ-126` is resolved only for the accepted row-001 through row-020
  payloads that created `FJ101`--`FJ120`.
...
- `OBL-C5-021`: post-FJ100 prompt-backlog maintenance / reflection
  ...
  accepted callback rows 001--020.
...
- `OBL-C6-003`: completed only for accepted callback rows 001--020, which
  instantiated `FJ101`--`FJ120`. Template prompts and generic continuation
